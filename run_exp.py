...
experiments: Dict[str, Dict[str,str]] = {
    ...
    "ant_orientation_alignment__withgait_d0.3_smooth10_v4":{
        ...
        "task_overrides": " \""+
            ...
            " TASK.MEASUREMENTS [UPRIGHT_ORIENTATION_DEVIATION_VALUE,FORWARD_ORIENTATION_DEVIATION_VALUE,ACTION_COST,ACTION_SMOOTHNESS,COMPOSITE_ANT_REWARD]" +
            " SIMULATOR.TARGET_VECTOR \"RANDOM\""+
            " TASK.COMPOSITE_ANT_REWARD.COMPONENTS [UPRIGHT_ORIENTATION_DEVIATION_VALUE,FORWARD_ORIENTATION_DEVIATION_VALUE,ACTION_COST,ACTION_SMOOTHNESS]"+
